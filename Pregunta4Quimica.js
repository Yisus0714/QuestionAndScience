...
document.getElementById('texto').innerHTML = "Después de una hora de haber hecho <br> el experimento anterior, el rey <br> le encargó a Osash prepararle un brebaje que <br> le ayude a mantenerse despierto <br> utilizando unos extraños granos traídos <br> desde África llamados 'café', <br> ¿Qué técnica de separación debería utilizar para esto?"
...
function mostrarMensaje(texto) {
  ...
  if (texto === 'Texto 4') {
    ...
    Swal.fire({
      ...
      // Redirigir al usuario a la página 'Pregunta5Quimica.html'
      window.location.href = 'Pregunta5Quimica.html';
